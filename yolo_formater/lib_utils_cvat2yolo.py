...
def create_YOLOv5_folder_tree(out_folder):
    ...
    Path(out_folder, "Train", "images").mkdir(parents=True, exist_ok=False)
    Path(out_folder, "Val", "images").mkdir(parents=True, exist_ok=False)
    Path(out_folder, "Test", "images").mkdir(parents=True, exist_ok=False)

    Path(out_folder, "Train", "labels").mkdir(parents=True, exist_ok=False)
    Path(out_folder, "Val", "labels").mkdir(parents=True, exist_ok=False)
    Path(out_folder, "Test", "labels").mkdir(parents=True, exist_ok=False)
